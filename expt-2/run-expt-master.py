...
yaml_files = [
    # "config-aes-go-1000000-1010000-10.yaml",
    # "config-aes-nodejs-100000-101000-10.yaml",
    # "config-aes-nodejs-700000-707000-10.yaml",
    # "config-aes-python-200000-202000-10.yaml",
    # "config-aes-python-45000-45450-10.yaml",
    # "config-aes-python-500-505-10.yaml",
    # "config-fibonacci-go-200000-202000-10.yaml",
    # "config-fibonacci-go-450000-454500-10.yaml",
    # "config-aes-go-1000000-1010000-200.yaml",
    # "config-aes-nodejs-100000-101000-200.yaml",
    # "config-aes-nodejs-700000-707000-200.yaml",
    # "config-aes-python-200000-202000-200.yaml",
    # "config-aes-python-45000-45450-200.yaml",
    # "config-aes-python-500-505-200.yaml",
    # "config-fibonacci-go-200000-202000-200.yaml",
    # "config-fibonacci-go-450000-454500-200.yaml",
    # "config-aes-go-1000000-1010000-450.yaml",
    # "config-aes-nodejs-100000-101000-450.yaml",
    # "config-aes-nodejs-700000-707000-450.yaml",
    # "config-aes-python-200000-202000-450.yaml",
    # "config-aes-python-45000-45450-450.yaml",
    # "config-aes-python-500-505-450.yaml",
    # "config-fibonacci-go-200000-202000-450.yaml",
    # "config-fibonacci-go-450000-454500-450.yaml",

    # "config-fibonacci-go-70000-70700-10.yaml",
    # "config-fibonacci-python-200000-202000-10.yaml",
    # "config-fibonacci-python-20000-20200-10.yaml",
    # "config-gptj-python-10.yaml",
    # "config-image-rotate-go-14-10.yaml",
    # "config-image-rotate-go-3-10.yaml",
    # "config-image-rotate-go-6-10.yaml",
    # "config-image-rotate-python-11-10.yaml",
    # "config-fibonacci-go-70000-70700-200.yaml",
    # "config-fibonacci-python-200000-202000-200.yaml",
    # "config-fibonacci-python-20000-20200-200.yaml",
    # "config-gptj-python-200.yaml",
    # "config-image-rotate-go-14-200.yaml",
    # "config-image-rotate-go-3-200.yaml",
    # "config-image-rotate-go-6-200.yaml",
    # "config-image-rotate-python-11-200.yaml",
    # "config-fibonacci-go-70000-70700-450.yaml",
    # "config-fibonacci-python-200000-202000-450.yaml",
    # "config-fibonacci-python-20000-20200-450.yaml",
    # "config-gptj-python-450.yaml",
    # "config-image-rotate-go-14-450.yaml",
...
def send_file_via_scp(server_ip, username, file_path, remote_path):
    ...
    try:
        ...
        # ]
        scp_command = f"scp -r {file_path} {username}@{server_ip}:{remote_path}"
