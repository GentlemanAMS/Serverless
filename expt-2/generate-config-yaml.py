...
function_name="image-rotate-python-17"
yaml_path = "/users/ArunAMS/vSwarm/tools/load-generator/yamls/image-rotate-python/kn-image-rotate-python-17.yaml"
grep_string = "python3 /app/server.py"
predeployment_command = "kubectl apply -f /users/ArunAMS/vSwarm/tools/load-generator/yamls/image-rotate-go/image-rotate-database.yaml"
load_expt_dur = 9
load_warmup_dur = 2
